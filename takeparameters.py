...
if __name__=='__main__':
    ...
    resume_model = 'best_model/re_add_tag_6_exp_4_0.0_40_AUC80.pt'#'gaussian_weight_resume.pt'#
    # if ARGS.resume == 1:
    print('Resuming the model {}'.format(resume_model))
    model.load_state_dict(torch.load(resume_model))
    
    model_check = model()
    print(count_parameters(model_check))
    #print(count_allparameters(model_check))
